    ...
    <header className="flex items-center justify-between mb-4.5 lg:mb-6 gap-3">
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        <Form
          method="get"
          action="/transaksi"
          className="hidden lg:flex items-center gap-2 px-3.5 py-2 rounded-xl bg-brand-surface-2 border border-brand-hairline text-brand-text-dim text-[12.5px] min-w-[220px] h-[38px]"
        >
          <SearchIcon size={14} />
          <input
            name="q"
